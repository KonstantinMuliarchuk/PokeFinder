...
//  PokeFinder
//
//  Created by Мулярчук Константин on 30.07.17.
...
class ViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    func createSighting(forLocaion location: CLLocation, withPokenon pokeId: Int) {
    ...
    @IBAction func spotRandomPokemon(_ sender: UIButton) {
        ...
        createSighting(forLocaion: location, withPokenon: Int(rand))
    }
